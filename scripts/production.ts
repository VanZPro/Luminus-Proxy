...
// (import.meta.url.pathname alone yields "/E:/..." which breaks exists checks)
...
// Always re-exec via the same bun binary that launched us. On Windows an
// extensionless "bun" on PATH (e.g. Kiro-Cli) is not spawnable and yields ENOENT.
const bunBin = process.execPath;

async function buildDashboard() {
  const distExists = existsSync(dashboardDist);
