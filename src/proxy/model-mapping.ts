...
function isNativeProviderId(model: string): boolean {
  ...
  if (model.startsWith("cb-")) return true;          // CodeBuddy (legacy alias)
  if (model.startsWith("cb/")) return true;          // CodeBuddy (cb/<upstream-id>)
  if (model.startsWith("cbc-")) return true;         // CodeBuddy China
