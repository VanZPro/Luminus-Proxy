...
const IDEMPOTENT_COLUMNS: Array<{ table: string; column: string; ddl: string }> = [
  ...
  // 2026-08-03 — Custom API keys: public-only flag + expiry date.
  { table: "api_keys", column: "is_public_only", ddl: "ALTER TABLE api_keys ADD COLUMN is_public_only INTEGER NOT NULL DEFAULT 1" },
