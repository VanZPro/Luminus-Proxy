...
R21 defines the separate provider-configuration boundary in `docs/rust-provider-config-architecture.md`; credentials remain secret-only and are resolved after configuration succeeds.
