        ...
        <CardContent className="p-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-[var(--background)] border border-[var(--border)] rounded-md text-sm text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:outline-none focus-visible:ring-1 focus-visible:ring-[var(--ring)]"
            />
          </div>
        </CardContent>
      </Card>
