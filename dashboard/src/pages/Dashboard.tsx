  ...
  return (
    <div className="space-y-6">
      <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5 shadow-[var(--shadow-card)]">
        <div>
          <p className="text-xs font-medium uppercase tracking-wider text-[var(--muted-foreground)]">Luminus Command Center</p>
          <h1 className="mt-1 text-2xl font-bold text-[var(--foreground)]">AI Proxy Gateway</h1>
          <p className="text-sm text-[var(--muted-foreground)] mt-1.5 max-w-2xl">
            Live provider pool, token flow, and model routing in one control plane.
          </p>
        </div>
      </div>
